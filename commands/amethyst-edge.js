...
module.exports = {
	name: "amethsyt-edge",
	aliases: ['amethystedge'],
	cooldown: 4,
	execute(message) {

		const embed = new Discord.MessageEmbed()
			.setColor(mystic)
			.setAuthor('Amethyst Edge', 'https://media.discordapp.net/attachments/747913618284347527/817100934668484628/oie_g27W8y3zOLJJ.png')
			.setThumbnail('https://media.discordapp.net/attachments/747913618284347527/817829670858915883/Amethyst_Edge.png')
			.setDescription('\u200B')
			.addFields(
