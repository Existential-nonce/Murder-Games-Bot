...
module.exports = {
	...
	execute(message) {
		...
		const embed = new Discord.MessageEmbed()
			.setColor(legendary)
			.setAuthor('Apparatus', 'https://media.discordapp.net/attachments/747913618284347527/817100934668484628/oie_g27W8y3zOLJJ.png')
			.setThumbnail('https://media.discordapp.net/attachments/747913618284347527/817840265510649876/Apparatus.png')
			.setDescription('\u200B')
			.addFields(
