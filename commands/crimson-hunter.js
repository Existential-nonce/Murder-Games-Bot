...
module.exports = {
	name: "crimson-hunter",
	aliases: ['crimson', 'hunter', 'crimsonhunter'],
	cooldown: 4,
	execute(message) {

		const embed = new Discord.MessageEmbed()
			.setColor(mystic)
			.setAuthor('Crimson Hunter', 'https://media.discordapp.net/attachments/747913618284347527/817100934668484628/oie_g27W8y3zOLJJ.png')
			.setThumbnail('https://media.discordapp.net/attachments/747913618284347527/817833613462339604/Crimson_Hunter.png')
			.setDescription('\u200B')
			.addFields(
