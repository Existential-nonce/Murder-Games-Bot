...
module.exports = {
	...
	execute(message) {
		...
		const embed = new Discord.MessageEmbed()
			.setColor(legendary)
			.setAuthor('Amethyst', 'https://media.discordapp.net/attachments/747913618284347527/817100934668484628/oie_g27W8y3zOLJJ.png')
			.setThumbnail('https://media.discordapp.net/attachments/747913618284347527/817839167274876948/Amethyst.png')
			.setDescription('\u200B')
			.addFields(
