...
module.exports = {
	...
	execute(message) {
		...
		const embed = new Discord.MessageEmbed()
			.setColor(mystic)
			.setAuthor('Vipera', 'https://media.discordapp.net/attachments/747913618284347527/817100934668484628/oie_g27W8y3zOLJJ.png')
			.setThumbnail('https://media.discordapp.net/attachments/747913618284347527/817830833091117096/Vipera.png')
			.setDescription('\u200B')
			.addFields(
